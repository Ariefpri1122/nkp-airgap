...
openssl req -newkey rsa:4096 -nodes -sha256 -keyout certs/domain.key -x509 -days 365 -out certs/domain.crt -subj "/C=ID/ST=Indonesia/L=Jakarta/O=Nutanix/OU=IT/CN=*.nutanix.local"
